...
| 62  | Risonanza Eterica - Rileva firme di energia aeterica, rivelando meccanismi nascosti. |
...
| 56  | Danza Tempestosa: Manovra attraverso una stupefacente tempesta di etere in movimento. |
...
| 41  | Talismano Pietrascura  | Un talismano che genera e immagazzina scintille di energia eterea.                                   | Rilascia esplosioni di energia eterea per vari effetti. | Un uso improprio può portare a conseguenze esplosive. | Bazar Corazzato                     |
...
| 42  | Automaton Ether-Scribe | Un automa in grado di registrare fenomeni ed eventi eterici, conservandoli per un'analisi successiva. | L'Istituto Tecnologico     | Un uso eccessivo potrebbe portare a registrazioni distorti o inaccurate. | La conoscenza e la storia eteriche sono meglio conservate. |
...
| 14  | Darsene del Lungofiume: Indaga sulle attività di contrabbando lungo i moli. |
...
### Leggende Urbane o Voci di Corridoio
...
| 66  | Un'esplosione catastrofica scuote la Fonderia dell'Eterio, causando danni diffusi e rilasciando pericolosa energia eterea. |
...
| 64  | Gli Spaccacieli scoprono una rete segreta di tunnel sotterranei che potrebbe contenere la chiave della loro causa. |
| 65  | Gli automatoni a ingranaggio acquisiscono improvvisamente coscienza e iniziano ad agire autonomamente, mettendo in discussione la loro stessa natura. |
| 66  | Un'esplosione catastrofica scuote la Fonderia dell'Eterio, causando danni diffusi e rilasciando pericolosa energia eterea. |
...
| D66 | Avventura                                                                                                                              |
| --- | ------------------------------------------------------------------------------------------------------------------------------------- |
| 11  | Gli Ingegneri Eterici chiamano il protagonista per recuperare un Nucleo Eterico rubato dalla cassaforte del Sindacato dell'Ingranaggio.             |
| 12  | L'astronave di Victor Ironheart viene dirottata dall'Avanguardia di Ferro, portando a un inseguimento aereo e a un confronto per la supremazia delle astronavi.  |
| 13  | Isabella Thornfield chiede l'aiuto del gruppo per smantellare un'arma degli Spaccacieli che minaccia di scatenare un'onda cataclismica di smog.    |
| 14  | Lord Percival Sterling invita gli eroi a una spedizione per scoprire la città perduta all'interno della nebbia sempre presente del Bosco della Canzone di Nebbia. |
| 15  | Il Nexus Arcano affronta una perturbazione magica, e il protagonista deve scoprire la causa in mezzo a tensioni politiche all'interno del consiglio. |
| 16  | I Nomadi Eterici percepiscono una catastrofe cosmica imminente e affidano ai protagonisti il compito di individuare un artefatto che può prevenire la catastrofe. |
| 21  | Il Bazaar dell'Corazzata viene attaccato da una fazione sconosciuta, e il protagonista deve difendere i commercianti e scoprire il motivo.  |
| 22  | La ribellione degli operai del vapore al Citadello dell'Ingranaggio si intensifica, e gli eroi devono mediare tra il Consiglio degli Ingranaggi e i ribelli.     |
| 23  | Il gruppo viene assunto dalla Lega della Neo-Aristocrazia per investigare su una serie di misteriose sparizioni tra i lavoratori delle classi inferiori. |
| 24  | Un malfunzionamento presso l'Osservatorio del Cielo Azzurro minaccia di destabilizzare i cieli, e i Cartografi Astrali hanno bisogno dell'aiuto del gruppo.  |
| 25  | Un inventore ribelle cerca di sfruttare il potere delle bestie incantate di Whisperwind, e gli eroi devono prevenire una catastrofe naturale.     |
| 26  | Gli Etereologi della Fonderia dell'Eterio hanno bisogno dell'aiuto del protagonista per respingere un'abominio tecnologico creato dai loro rivali. |
| 31  | Il Sindacato dell'Ingranaggio pianifica di rubare un prezioso artefatto dal Bazaar dell'Corazzata, e gli eroi devono ostacolare il loro colpo.      |
| 32  | Aurora Whisperwind riceve una visione di un evento celeste corrotto, e il gruppo gareggia contro il tempo per prevenire una crisi ultraterrena. |
| 33  | Gli Spaccacieli scoprono un complotto di un industriale per avvelenare i cieli, e gli eroi devono trovare le prove per esporre la verità.     |
| 34  | L'aggressività dell'Avanguardia di Ferro si intensifica, portando a un confronto in una fortezza alimentata da Eterio che potrebbe cambiare l'ordine mondiale. |
| 35  | Il protagonista riceve un misterioso pacchetto contenente una mappa che indica un tesoro nascosto di cui si vocifera possieda un potere immenso.       |
| 36  | Gli Ingegneri Eterici sviluppano un nuovo sistema di propulsione che suscita l'interesse di varie fazioni, dando il via a una corsa per la tecnologia. |
| 41  | Gli eroi sono incaricati di scortare un inviato diplomatico attraverso cieli insidiosi, affrontando minacce da parte di pirati aerei e nazioni rivali.  |
| 42  | L'invenzione sperimentale di Eleanora Blackthorn va fuori controllo, mettendo in pericolo la città, e il gruppo deve neutralizzare il malfunzionamento.       |
| 43  | La Lega della Neo-Aristocrazia chiede l'aiuto dei protagonisti per sopprimere un'incipiente insurrezione degli operai che minaccia di rovesciare la società.   |
| 44  | L'Avanguardia di Ferro lancia un attacco totale al Citadello dell'Ingranaggio, e gli eroi devono mobilitare la difesa per salvaguardare la città.  |
| 45  | I Nomadi Eterici prevedono un imminente tentativo di assassinio nei confronti di una figura prominente, e il gruppo corre per prevenire l'evento tragico.   |
| 46  | Victor Ironheart riceve una chiamata di soccorso da un'astronave in avaria, portando gli eroi in una pericolosa missione di salvataggio attraverso cieli pericolosi. |
| 51  | Il Sindacato dell'Ingranaggio si rivolge agli eroi con la proposta di rubare un antico artefatto da un sito archeologico ben custodito. |
| 52  | Isabella Thornfield scopre una fonte di energia alternativa nel cuore del Bosco della Canzone di Nebbia, ma risveglia antichi guardiani della foresta. |
| 53  | Il protagonista è invitato a un vertice segreto presso il Nexus Arcano, dove le fazioni lottano per il controllo su un potente artefatto magico. |
| 54  | Una pericolosa creatura dalla Fonderia dell'Eterio scappa, e gli eroi devono rintracciarla prima che scateni il caos sulla città.    |
| 55  | Gli Spaccacieli scoprono una cospirazione per scatenare un mostro alimentato dallo smog, e il gruppo deve fermare la sua furia attraverso la città. |
| 56  | Gli eroi incappano in una base segreta dell'Avanguardia di Ferro, rivelando il loro piano di scatenare una guerra tra le nazioni per la dominanza. |
| 62  | Gli operai del vapore oppressi del Citadello dell'Ingranaggio si rivolgono al sabotaggio, e gli eroi devono placare la situazione prima che scoppino il caos. |
| 63  | Un malfunzionamento nei cristalli dell'Eterio minaccia di distruggere il Nexus Arcano, e il gruppo deve addentrarsi nel cuore della questione.     |
