...
***[Product Name]*** is a solo tabletop RPG adventure set in [brief description of the setting].

This minimalist Solo Role Playing Game is designed to be [brief introductory text about the game].

## Introduction

*[Product Name]* follows the following design principles:
...
With a focus on quick resolutions, **[Product Name]** throws you headfirst into the heart of the action. Your character will be defined by thematic tags, [example of tags].
...
In *[Product Name]* Non-Playing Characters (NPCs), Foes, Organizations, Monsters, and even relevant objects like vehicles are characters too!
...
[Detail the features of your setting as you like: you can use whole paragraphs, bullet points, or refer back to the generation tables! 
Below are some suggested sections to break up this chapter, but use them as examples only and adapt them to your needs!]
