...
Loner è un gioco di ruolo solitario minimalista progettato per giocare con un personaggio solo in modalità "narrativa". Guiderai il tuo personaggio attraverso la storia che si svilupperà durante il gioco, chiedendo domande chiuse a un oracolo che assumerà il ruolo di Game Master. Ogni tanto il gioco ti sorprenderà quando succederà un colpo di scena inaspettato!

Per giocare, si assume che tu sia già familiarità con il mondo dei giochi di ruolo e dei giochi solitari. Un buon punto di partenza per avere un'idea sono la pagina [GDR](https://en.wikipedia.org/wiki/Role-playing_game) su Wikipedia.
...
> Coltello, Pillone contro la bassa O2.
...
## Mantenere l'azione in movimento

Un gioco in Loner è una successione di scene. Una scena è un'unità di tempo in cui si svolge una determinata azione alla ricerca di un determinato obiettivo a breve termine. In un gioco di ruolo tradizionale, è il Game Master che propone la scena e muove il mondo e i PNJ. In un gioco di ruolo solitario, invece, il giocatore fa domande all'Oracle (come farebbe con un GM) che fornirà una risposta chiusa. È quindi necessario formulare domande il cui risposta sia binaria (Sì/No).

Avrai bisogno di 2d6 di un colore (**Dadi Possibilità**), e 2d6 di un altro colore (**Dadi Rischio**).

Per risolvere una domanda chiusa, lanciare un **Dado Possibilità** e un **Dado Rischio**. Se il Dado Possibilità è il più alto, la risposta è **Sì**. Se il Dado Rischio è il più alto, la risposta è **No**.

Inoltre guarda il valore su ciascun dado. Se entrambi sono bassi (3 o meno), aggiungi **Ma**. Se entrambi sono alti (4 o più), aggiungi **E**.

**Esempio**
> Chiedi: "Riesce Zahra a forzare il portello?" Lanci un Dado Possibilità e un Dado Rischio e ottieni (5) [4]). La risposta è **Sì**, perché il Dado Possibilità è più alto. Aggiungi anche **E**, perché entrambi i tiri sono 4 o più. Se il Dado Rischio fosse stato [3], sarebbe stato un semplice **Sì** invece.

## Vantaggio e Svantaggio

Se le circostanze o i tratti positivi garantiscono un vantaggio, aggiungere un **Dado Occasione** al tiro. Altrimenti, quando ostacoli o tratti negativi causano uno svantaggio, aggiungere un **Dado Rischio**. In entrambi i casi, quando si controlla il tiro si tiene solo il dado più alto del tipo aggiunto.

**Esempio**
> Si chiede: "Zahra hackera il datapad?". Si tira un dado Possibilità e due dadi Rischio, poiché Zahra non ha alcun vantaggio nell'hacking e il datapad è l'obiettivo della missione, comprometterlo farebbe fallire la missione. Si ottiene (4) [4] [5]. Si scarta il dado rischio più basso [4] e si tengono (4) e [5]. Si ottiene un **No** e si aggiunge un **E** dato che sono entrambi 4 o superiori. Questo hacking è andato davvero male...

## Danno e fortuna

Quando si è in conflitto, il gioco si svolge a turni alternati tra giocatore e PNG. Quando si fallisce la difesa, si riduce la propria Fortuna in base alla tabella seguente. Anche i PNG hanno un tratto Fortuna. Se si attacca in qualsiasi modo, si riduce la Fortuna del bersaglio secondo la tabella seguente. Quando la vostra Fortuna si esaurisce, siete in pericolo di vita e il prossimo attacco vi porterà fuori dal conflitto.
...
| Si ottiene ciò che si vuole? | Danno
|---|---| --- |
...
|No, e... | Non si ottiene quello che si vuole e le cose peggiorano.| Take 3| 

**Esempio**
> Zahra affronta un delinquente in un vicolo. È "Artista marziale", "Combattimento corpo a corpo", "Felino" e "Basso". Zahra cerca di colpirlo con il coltello, tu tiri (5) (6) [4] ("Sì, e...", causando una perdita di Fortuna di 3 al teppista). Il teppista tira un calcio circolare a Zahra (tiro (3) (2) [2], "Sì, ma...", causando una perdita di Fortuna di 1 a Zahra). Chi vincerà? 

## Raddoppi e il Contatore di torsione
Il Contatore dei colpi di scena è una misura della tensione crescente nella narrazione. All'inizio è impostato a 0. Ogni volta che avviene un doppio lancio (i dadi sono uguali), si aggiunge 1 al Contatore. Se il Contatore è inferiore a tre, la risposta è "**Sì, ma...**". Altrimenti si verifica un **Twist** che azzera il contatore.

**Esempio**
> Chiedete se il datapad contiene dati sensati sulle attività illecite di Wethern. Si tira (4) [4]. La risposta è "Sì, ma...". Aggiungete 1 al contatore di torsione. Ma il contatore era già a 2, quindi si verifica un colpo di scena! Il contatore si azzera a 0.
...
Interpretare la frase di due parole nel contesto della scena corrente. I colpi di scena faranno evolvere la trama e gli eventi in modo inaspettato.
...
Alla fine della scena in corso, potrebbe essere necessario determinare l'umore generale della scena successiva. In questo caso tirate 1d6 e consultate la seguente tabella:
...
**Esempio
> Zahra accetta la proposta, si sa che si rotola per la scena successiva: 6, nel frattempo. Nella scena seguente, Tobias Wethern assume un sicario per uccidere Zahra...

## Risposte sibilline
A volte l'Oracolo può dare risposte che non hanno senso nel contesto della scena. Non siate tentati di dettagliare la risposta con troppe domande in sequenza. Tre domande dovrebbero essere sufficienti. Se siete ancora bloccati, provate a usare una domanda aperta per sbloccarvi o interpretare la risposta come "Sì, ma..." e portare avanti la storia. 

## Domanda aperta o Ispirazione

Per rispondere a una domanda aperta, tirare 1d6 una volta su ciascuna delle seguenti tabelle (tirare almeno un verbo e un nome, gli aggettivi sono facoltativi).

| Verbi | 1 | 2 | 3 | 4 | 5 | 6 |
|:-----:|:--------:|:------:|:-------:|:--------:|:-------:|:-------:|
| 1 | iniettare | passare | possedere | dividere | seppellire | prendere in prestito |
| 2 | continua | impara | chiedi | moltiplica | ricevi | immagina |
| 3 | sviluppare | comportarsi | sostituire | danneggiare | raccogliere | trasformare |
| 4 | condividere | mano | suonare | spiegare | migliorare | tossire |
| 5 | affrontare | espandere | trovare | radunare | preferire | appartenere |
| 6 | viaggio | volere | mancare | asciugare | impiegare | distruggere |

| Sostantivi | 1 | 2 | 3 | 4 | 5 | 6 |
|:-----:|:----------:|:-------:|:------:|:------:|:---------:|:--------:|
| 1 | causa | stadio | cambiamento | verso | brivido | spot |
...
|:----------:|:-----------:|:-------------:|:---------:|:-------------:|:-----------:|:---------:|
| 1 | frequente | difettoso | osceno | scarso | rigido | a lungo termine |
...
| 4 | setoso | senza valore | fisso | sciolto | volenteroso | freddo |
| 5 | tranquillo | tempestoso | spettrale | delirante | innato | tardivo |
| 6 | magnifico | arrogante | malsano | enorme | truculento | affascinante |

**Esempio**
> Chiedi: "Zahra ha amici a cui chiedere aiuto contro il sicario?". Tiri 24 e 32: moltiplica il movimento. Zahra deve muoversi rapidamente per raggiungere Melina Reade, un'hacker con contatti nella malavita che potrebbe aiutarla!

## Quando la storia finisce
Alla fine dell'avventura si possono aggiungere altri tratti al personaggio. È meglio che questo sia legato alla storia appena conclusa e può essere un'Abilità, un Equipaggiamento o una nuova Fragilità o addirittura una nuova Nemesi! È anche possibile modificare un tratto esistente per rappresentare meglio un'abilità potenziata.

Si noti anche l'elenco dei contatti, dei nemici e di tutti gli eventi, le persone o gli oggetti che potrebbero ripresentarsi nelle avventure future.
...
Le meccaniche di Harm sono tratte da 6Q System (CC BY 4.0) di Marcus Burggraf.
